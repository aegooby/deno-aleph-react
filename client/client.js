...
class App extends me {
    constructor(props){
        super(props);
    }
    render() {
        const reactVersion = Ue;
        const element = Oe("div", {
            className: "page"
        }, Oe("p", {
            className: "logo"
        }), Oe("h1", null, Oe("strong", null, "Deno"), " v", this.props.denoVersion), Oe("div", {
            className: "counter"
        }), Oe("p", {
            className: "copyinfo"
        }, "React v", reactVersion, " (deno-react)"));
        return element;
    }
}
_c(Oe(App, {
